...
export const SEO_PATTERNS: Record<string, IssuePattern> = {
  ...
  SITEMAP_TOO_LARGE: {
    id: 'SITEMAP_TOO_LARGE',
    category: 'sitemap',
    severity: 'CRITICAL',
    message: 'Sitemap exceeds 50MB uncompressed limit',
    fix: 'Split sitemap into multiple files and create a sitemap index',
    documentation: 'commands/fix-sitemap.md',
  },
  SITEMAP_TOO_MANY_URLS: {
    id: 'SITEMAP_TOO_MANY_URLS',
    category: 'sitemap',
    severity: 'CRITICAL',
  ...
  SITEMAP_TOO_MANY_SITEMAPS: {
    id: 'SITEMAP_TOO_MANY_SITEMAPS',
    category: 'sitemap',
    severity: 'CRITICAL',
    message: 'Sitemap index contains more than 50,000 sitemaps',
    fix: 'Reduce sitemap index size to 50,000 entries or fewer',
    documentation: 'commands/fix-sitemap.md',
  },
  SITEMAP_MISSING_LOC: {
    id: 'SITEMAP_MISSING_LOC',
    category: 'sitemap',
    severity: 'HIGH',
    message: 'Sitemap entries missing required <loc> tag',
    fix: 'Ensure every <url> or <sitemap> entry has a <loc> tag',
    documentation: 'commands/fix-sitemap.md',
  },
  SITEMAP_INVALID_URL: {
    ...
    category: 'sitemap',
    severity: 'HIGH',
    message: 'Sitemap contains invalid or non-absolute URLs',
    fix: 'Use absolute URLs that start with https://',
    documentation: 'commands/fix-sitemap.md',
  },
  SITEMAP_URL_NOT_ALLOWED: {
    id: 'SITEMAP_URL_NOT_ALLOWED',
    category: 'sitemap',
    severity: 'HIGH',
    message: 'Sitemap contains URLs outside the allowed host/path scope',
    fix: 'Only include URLs on the same host and within the sitemap directory scope',
    documentation: 'commands/fix-sitemap.md',
  },
  SITEMAP_WWW_MISMATCH: {
    id: 'SITEMAP_WWW_MISMATCH',
    category: 'sitemap',
    severity: 'HIGH',
    message: 'Sitemap URLs mismatch www vs non-www host',
    fix: 'Make sitemap host consistent with canonical host (www vs non-www)',
    documentation: 'commands/fix-sitemap.md',
  },
  SITEMAP_INVALID_DATE: {
    id: 'SITEMAP_INVALID_DATE',
    category: 'sitemap',
    severity: 'HIGH',
    message: 'Sitemap lastmod dates are invalid',
    fix: 'Use ISO 8601 or YYYY-MM-DD for lastmod',
    documentation: 'commands/fix-sitemap.md',
  },
  SITEMAP_INVALID_TAG_VALUE: {
    id: 'SITEMAP_INVALID_TAG_VALUE',
    category: 'sitemap',
    severity: 'HIGH',
    message: 'Sitemap changefreq/priority values are invalid',
    fix: 'Use valid changefreq values and priority between 0.0 and 1.0',
    documentation: 'commands/fix-sitemap.md',
  },
  SITEMAP_NESTED_INDEX: {
    id: 'SITEMAP_NESTED_INDEX',
    category: 'sitemap',
    severity: 'HIGH',
    message: 'Sitemap index contains nested sitemap indexes',
    fix: 'Sitemap indexes should only list URL sitemaps, not other indexes',
    documentation: 'commands/fix-sitemap.md',
  },
